...
Setup:
-install mysql/postgresql server depending on the used connection-string then create 'claim-center' schema (not required for container)
...
https://www.enterprisedb.com/downloads/postgres-postgresql-downloads v 15.2
